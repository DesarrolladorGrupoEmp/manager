                       ...
                       echo '<tr';  if (is_null($pagado) || $pagado == '' || $pagado == 0) {
                             ...
                             echo'>
		                         ...
		                         <td>		                         	
		                             ...
		                             <button id="btn_aprobar" title="Aprobar" name="aprobar_gasto_gral" type="button" class="btn btn-primary" data-id-gasto_gral = "'.$id.'" ';  if (  ($_COOKIE["log_lunelAdmin_IDtipo"] == 3) || ($_COOKIE["log_lunelAdmin_IDtipo"] == 1)  ){echo '';}else{ echo 'style="display: none;"'; }; if ( is_null($aprobado) || $aprobado == '' || $aprobado == 0){echo '';}else{ echo 'style="display: none;"'; }; echo '><span class="glyphicon glyphicon-ok"></span></button>
		                         </td> 
		                     </tr>';
                };
