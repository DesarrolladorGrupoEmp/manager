    ...
    <div class="row">
        ...
        <div class="col-lg-12 rowhv3">
            <ol class="breadcrumb">
              ...
              <li><a href="hvida.php?s=*">Hojas de Vida</a></li>
              <li class="active">Detalles Hoja de vida</li>
              <li>
                <?php 
                    echo '<a id="btn_editar" title="Editar" name="edita_hvida" data-toggle="modal" data-target="#form_modal_hvida" data-id-hvida = "'.$id_hoja.'" '; if ($editaPersonal != 1){echo 'disabled="disabled"';} echo '>Editar</a>'
                ?>
              </li>
            </ol>
        </div>
